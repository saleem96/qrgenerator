		...
		<ul class="navbar-nav ml-auto">
            ...
            <div class="col-12">
                <ul class="nav nav-pills nav-fill" role="tablist">
                        ...
                        <li class="nav-item">
                        <a class="nav-link rounded-pill" href="#text" role="tab" data-bs-toggle="tab" data-toggle="tab"><i class="fa fa-align-left"></i> <span class="d-inline-block d-sm-inline-block">Text</span></a>
                    </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                        <a class="nav-link rounded-pill" href="#location" role="tab" data-bs-toggle="tab" data-toggle="tab"><i class="fa fa-map-marker"></i> <span class="d-inline-block d-sm-inline-block">Location</span></a>
                    </li>
                        <li class="nav-item">
                        <a class="nav-link rounded-pill" href="#tel" role="tab" data-bs-toggle="tab" data-toggle="tab"><i class="fa fa-phone"></i> <span class="d-inline-block d-sm-inline-block">Phone</span></a>
                    </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                        <a class="nav-link rounded-pill" href="#event" role="tab" data-bs-toggle="tab" data-toggle="tab"><i class="fa fa-calendar-o"></i> <span class="d-inline-block d-sm-inline-block">Event</span></a>
                    </li>
                        <li class="nav-item">
