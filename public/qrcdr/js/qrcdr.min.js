    ...
    t.fn.extend({
        qrcdr: function(e) {
            ...
            return this.each(function() {
                ...
                function A(t, e) {
                    t.parent(".qrcdr-slider").find(".qrcdr-slider-value").html(e + "%")
                }
                t("[maxlength]").maxlength({
                    alwaysShow: !0,
                    validate: !0,
                    appendToParent: !0
                }), t(".toast").toast(), S.each(function() {
                    var e = t(this).val();
                    A(t(this), e)
                }), S.on("input", function() {
                    var e = t(this).val();
                    ...
                    t(this).prop("checked") ? t(e).collapse("show") : t(e).collapse("hide")
                }), m.on("change", function() {
                    var e = t(this).data("target");
                    t(this).prop("checked") ? t(e).collapse("hide") : t(e).collapse("show")
                }), m.each(function() {
                    var e = t(this).data("target");
                    t(this).prop("checked") ? t(e).collapse("hide") : t(e).collapse("show")
                }), h.on("change", function() {
                    t(this).prop("checked") ? (i.spectrum("set", "transparent"), i.spectrum("disable")) : (i.spectrum("set", "#ffffff"), i.spectrum("enable"))
                }), h.prop("checked") ? (i.spectrum("set", "transparent"), i.spectrum("disable")) : (i.spectrum("set", "#ffffff"), i.spectrum("enable"));
                var N = document.getElementsByClassName("needs-validation");
                ...
                function R() {
                    t(".toast").toast("hide"), clearTimeout(C), v.attr("disabled", !0), s.html(""), p.data("gradient", !1), C = setTimeout(function() {
                        a[0].checkValidity() || c.click(), i.spectrum("enable"), l.fadeIn(100, function() {
                            var a = e.find(V + " :input"),
                                n = "section=" + V + "&";
                            n += a.filter(function(e, a) {
                                return "" != t(a).val()
                            }).serialize(), n += "&", n += I.filter(function(e, a) {
                                return "" != t(a).val()
                            }).serialize(),
                            //console.log(n)
                             t.ajax({
                                type: "POST",
                                url: q + "ajax/process.php",
                                cache: !1,
                                data: n
                            }).fail(function(e) {
                                d.html(e.statusText), t(".toast").toast("show")
                            }).done(function(e) {
                                h.prop("checked") && i.spectrum("disable");
                                var a = JSON.parse(e);
                                a.hasOwnProperty("errore") ? (d.html(a.errore), t(".toast").toast("show"), p.html('<img src="' + a.placeholder + '">'), l.fadeOut("slow")) : (v.attr("disabled", !1), p.html(a.content), p.data("gradient", a.gradient), l.fadeOut("slow"), g.val(e))
                            })
                        })
                    }, 1e3)
                }
                ...
                function D(e) {
                    ...
                    var a = e.target;
                    t(a).hasClass("nopreview") || (v.attr("disabled", !0), s.html(""), clearTimeout(C), C = setTimeout(function() {
                        R()
                    }, 1e3))
                    }
                }
                ...
                function U() {
                    ...
                    t.ajax({
                        ...
                        if (a.length) {
                            var n = JSON.parse(a);
                            if (n.error) bootbox.alert({
                                message: n.error,
                                size: "small"
                            });
                            else {
                                var o = n.filedir + "/" + n.basename,
                                    c = '<button class="btn btn-default svgtopng" data-path="' + o + '">' + T + '</button><a href="#" class="btn btn-default d-none preload-png">' + _ + '</a><a class="serve-png d-none" href="' + o + '.png" download="' + n.basename + '.png" data-path="' + o + '">PNG</a>';
                                c = c + '<a class="btn btn-default serve-svg" href="' + o + '.svg" download="' + n.basename + '.svg">' + H + "</a>", p.data("gradient") || (c = c + '<a target="_blank" class="btn btn-default" href="' + q + "pdf/?f=" + n.basename + '">' + j + "</a>"), c = c + '<button class="btn btn-default print">' + B + "</button>", s.html(c), v.attr("disabled", !0), e.find(".print").on("click", function() {
                                    var e, a;
                                    e = t(".serve-svg").attr("href"), (a = window.open("about:blank", "_new")).document.open(), a.document.write('<html><head></head><body onload="window.print()" onafterprint="window.close()"><img src="' + e + '"/></body></html>'), a.document.close()
                                })
                            }
                        }
                    })
                ...
                function F() {
                    if (t("#map-canvas").length) {
                        k = t("#map-canvas").data("lat"), M = t("#map-canvas").data("lng");
                        var e, a, n = new google.maps.LatLng(k, M),
                            o = document.getElementById("pac-input"),
                            c = document.getElementById("latlong"),
                            s = document.getElementById("latbox"),
                            r = document.getElementById("lngbox"),
                            i = {
                                zoom: 10,
                                center: n
                            };
                        b = new google.maps.Map(document.getElementById("map-canvas"), i), a = new google.maps.places.SearchBox(o), e = new google.maps.Marker({
                            map: b,
                            draggable: !0,
                            ...
                            l(a)
                        }), b.controls[google.maps.ControlPosition.TOP_LEFT].push(c), s.value.length > 0 && r.value.length > 0 && d(Number(s.value), Number(r.value)), google.maps.event.addListener(a, "places_changed", function() {
                            var t = a.getPlaces();
                            if (0 != t.length)
                                for (var n, o = 0; n = t[o]; o++) e.setPosition(n.geometry.location), b.setCenter(n.geometry.location), l()
                        })
                    }
                    var l = function() {
                            s.value = e.getPosition().lat(), r.value = e.getPosition().lng(), R()
                        },
                        d = function(t, a) {
                            b.setCenter({
                                lat: t,
                    ...
                    t("#latbox, #lngbox").on("input", function() {
                        s.value.length > 0 && r.value.length > 0 && d(Number(s.value), Number(r.value))
                    })
                }
                n.on("input", D), o.on("change", function(e) {
                        var a = e.target;
                        t(a).hasClass("nopreview") || R()
                    }), v.on("click", function() {
                        U()
                    }), t(document).on("click", ".svgtopng", function() {
                        var e, a, n, o, c, s, r, i;
                        r = t(".svgtopng"), i = r.parent().find(".serve-png"), c = r.parent().find(".preload-png"), r.addClass("d-none"), c.removeClass("d-none"), o = i.attr("download"), s = r.data("path") + ".svg", e = new Image, a = document.createElement("canvas"), n = a.getContext("2d"), t("#svgtopng"), e.onload = function() {
                            var s = 2 * e.width,
                                l = 2 * e.height;
                            a.width = s, a.height = l, n.drawImage(e, 0, 0, s, l);
                            var d = a.toDataURL();
                            t.ajax({
                                type: "POST",
                                url: q + "ajax/png.php",
                                ...
                                "error" == t ? bootbox.alert({
                                    message: "File not found",
                                    size: "small"
                                }) : (c.addClass("d-none"), r.removeClass("d-none"), i[0].click())
                            })
                        }, e.src = s
                    }), f.on("change", function(e) {
                        if (t(this).removeClass("is-invalid"), this.files[0].type.match("image.*")) {
                            var a = this.files[0],
                                n = new Image;
                            n.crossOrigin = "Anonymous";
                            var o = new FileReader;
                            a.type.indexOf("svg") > 0 && "svg", o.onload = function(e) {
                                t(".logoselecta label").removeClass("active").find("input").removeAttr("checked");
                                var a = '<img src="' + e.target.result + '" class="user_watermark">';
                                t(".custom-watermark .hold-custom-watermark").html(a), n.src = t(".logoselecta .btn-group-toggle label").last().find("img").attr("src"), t(".custom-watermark").addClass("active"), t(".custom-watermark input").val(e.target.result).prop("checked", !0)
                            }, o.readAsDataURL(a), n.onload = function() {
                                var e = document.createElement("canvas"),
                                    a = this.width,
                                    o = this.height;
                                if (0 == a || 0 == o) return t("#upmarker").addClass("is-invalid"), t(".logoselecta .btn-group-toggle label").last().remove(), !1;
                                e.getContext("2d").drawImage(n, 0, 0), a > o ? (o *= 400 / a, a = 400) : (a *= 400 / o, o = 400), e.width = a, e.height = o, e.getContext("2d").drawImage(n, 0, 0, a, o);
                                var c = e.toDataURL();
                                t(".logoselecta .btn-group-toggle label").last().find("img").attr("src", c), t(".logoselecta .btn-group-toggle label").last().find("input[name='optionlogo']").val(c)
                            }
                        } else t(this).addClass("is-invalid")
                    }), t(".logoselecta img").each(function() {
                        var e = t(this);
                        if ("svg" == e.attr("src").split(".").pop()) {
                            var a = new Image;
                            a.crossOrigin = "Anonymous", a.onload = function() {
                                var t = this.width,
                                    n = this.height;
                                if (!t || !n) return e.parent().remove(), !1;
                                var o = document.createElement("canvas"),
                                    c = o.getContext("2d");
                                t > n ? (n *= 400 / t, t = 400) : (t *= 400 / n, n = 400), o.width = t, o.height = n, c.drawImage(a, 0, 0, t, n);
                                var s = o.toDataURL();
                                e.parent().find("input").attr("value", s)
                            }, a.src = e.attr("src")
                        }
                    }), w.length && (t(".datetimepicker-input").datetimepicker({
                        format: "LLL"
                    }), t(".datetimepicker-input").on("change.datetimepicker", function(e) {
                        var a = t(this).data("timestamp");
                        t(a).attr("value", e.date.unix())
                    })),
                    function(e, a) {
                        if (t("#wpol-admin-map").length) {
                            if (k = t("#wpol-admin-map").data("lat"), M = t("#wpol-admin-map").data("lng"), "undefined" == typeof ol || null === ol) return console.log("WARNING: OpenLayers Library not loaded"), !1;
                            var n = ol.proj.fromLonLat([M, k]),
                                o = new ol.View({
                                    center: n,
                                    zoom: 4
                                });
                            ...
                            var c, s = document.getElementById(a),
                                r = new ol.Overlay({
                                    position: n,
                            ...
                            b.addOverlay(r), b.getInteractions().forEach(function(t) {
                                t instanceof ol.interaction.DragPan && (c = t)
                            }), s.addEventListener("mousedown", function(t) {
                                c.setActive(!1), r.set("dragging", !0)
                            }), b.on("pointermove", function(t) {
                                !0 === r.get("dragging") && r.setPosition(t.coordinate)
                            }), b.on("pointerup", function(e) {
                                if (!0 === r.get("dragging")) {
                                    c.setActive(!0), r.set("dragging", !1);
                                    var a = e.coordinate,
                                        n = ol.proj.toLonLat(a);
                                    t(".venomaps-get-lat").val(n[1]), t(".venomaps-get-lon").val(n[0]), R()
                                }
                                ...
                                if (a.length > 3) {
                                    ...
                                    t.ajax({
                                        ...
                                        var a, n, c, s;
                                        n = (a = e)[0].lat, c = a[0].lon, s = ol.proj.fromLonLat([c, n]), r.setPosition(s), o.setCenter(s), o.setZoom(6), t(".venomaps-get-lat").val(n), t(".venomaps-get-lon").val(c), R()
                                    }).always(function() {
                                        e.fadeIn()
                                    })
                                }
                                ...
                                ! function(t, e) {
                                    ...
                                    r.setPosition(a), o.setCenter(a)
                                }(t(".venomaps-get-lat").val(), t(".venomaps-get-lon").val())
                            })
                        }
                    }(0, "infomarker_admin"), F(), O.on("shown.bs.tab", function(e) {
                        V = t(e.target).attr("href"), t("#getsec").val(V);
                        var a = location.href.split("#")[0] + V;
                        history.replaceState(null, null, a), "#location" == V && (F(), t("#wpol-admin-map").length && b.updateSize())
                    }), x.on("change", function() {
                        var e = t(this).val(),
                            a = t(this).data("target");
                        t(a).html(e)
                    }), t("#pp_type").on("change", function() {
                        "_donations" === t(this).val() ? (z.addClass("d-none"), y.removeClass("col-sm-3")) : (z.removeClass("d-none"), y.addClass("col-sm-3"))
                    }), L.on("input", function() {
                        var e = L.val();
                        t.ajax({
                            method: "POST",
                            url: q + "ajax/btc-check.php",
                            data: {
                                btc_account: e
                            }
                        }).done(function(t) {
                            t ? L.removeClass("is-invalid").addClass("is-valid") : L.removeClass("is-valid").addClass("is-invalid")
                        })
                    })
            })
        }
